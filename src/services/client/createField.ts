...
export default function createUnderField(rowCount = 9, columnCount = 9, difficulty = 0.05) {
  const field = [];
  ...
  const nonBombs: Extract<UnderState, BombCount>[] = Array(rowCount * columnCount - bombCount).fill(initialBombCount);
